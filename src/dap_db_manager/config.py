"""Configuration management for DAP DB Manager.
...
def get_config_dir() -> Path:
    ...
    Returns:
        Path to config directory (~/.ddm on all platforms)
    """
    config_dir = Path.home() / ".ddm"
...
class Config:
    ...
    DEFAULT_CONFIG: Dict[str, Any] = {
        ...
        "formats": {
            ...
            # Prefer album artist for consistency across compilation albums
            "artist": "%artist%",
            "album": "%album%",
            "genre": "%genre%",
            "composer": "%composer%",
